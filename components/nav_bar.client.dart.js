...
r=2
return b.b=new A.U("section",null,"navbar",null,null,null,null,A.k([A.hc(A.k([A.eD(A.k([new A.I("< ",null)],o),null),A.eD(A.k([new A.I("Taizul",null)],o),"brand"),A.eD(A.k([new A.I(" />",null)],o),null)],o),null),A.hc(A.k([A.bW(A.k([new A.I("HOME",null)],o),"navbar-label","#",null,null),A.bW(A.k([new A.I("ABOUT",null)],o),"navbar-label","#about",null,null),A.bW(A.k([new A.I("SERVICES",null)],o),"navbar-label","#services",null,null),A.bW(A.k([new A.I("PROJECTS",null)],o),"navbar-label","#projects",null,null),A.bW(A.k([new A.I("CONTACT",null)],o),"navbar-label","#contact",null,null),new A.c5("RESUME","https://drive.google.com/file/d/1QDosbrpcUTc1DhK4tH_cied56uZMYge5/view?usp=sharing",null)],o),"labels")],o),null),1
case 2:return 0
